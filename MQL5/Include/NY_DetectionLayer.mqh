...
// MFE/MAE: بیشینه‌ی حرکتِ موافق/مخالف نسبت به لبه (واحدِ باکس)، رویِ *کلِ* بازه (تا EOD)، مستقلِ از
// اینکه استاپ/TP خورده باشد یا نه — طبقِ قراردادِ برگه‌ی چشمی (ستونِ MFE حتی روی روزهایِ استاپی هم
// پر است).
//------------------------------------------------------------------
