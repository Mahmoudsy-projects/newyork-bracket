...
> ## 🏷️ وضعیتِ فعلی: **گزارشِ نهایی ساخته شد ✅ (کارهایِ ۱-۴، v1.7)**
> قدمِ ۲: `DayNet_R` رسمی ۸۷.۲٪/۹۲.۳٪/۸۶.۵٪. دیاگنوستیکِ ریورس و قدمِ ۳ی موقت هم تمام شدند —
> جزئیات در `docs/NY_FrozenDefinitions.md`.
>
> **نسخه‌ی نهایی:** طبقِ `docs/Manager_Decision_20260824.md`، پیکربندیِ مرجع (`0900-1000`/استاپ
> `۰.۵۰`/معماریِ جانشینیِ A) قفل و هر ۴ کارِ نهایی انجام شد:
> [`runs/2026-08-24_run7_v16_prelim/NY_Standalone_Report_FINAL.md`](runs/2026-08-24_run7_v16_prelim/NY_Standalone_Report_FINAL.md).
> **یافته‌هایِ کلیدی:** استاپِ نهایی=۰.۵۰ (آزمونِ پایداری هم‌علامت در هر دو نیمه)؛ E پیکربندیِ مرجع
> رویِ هر ۴ سناریوی هزینه (خام تا P90ِ استرس) مثبت ماند؛ کمیسیونِ xChief تجربی تأیید شد
> ($۲.۵/لات)؛ `BoxClose_Pos` الگویِ ادامه‌دهنده‌ی قویِ تکرارشونده نشان داد (تفسیرش با محمود/مدیر).
> **بازِ باقی‌مانده:** حکمِ رسمیِ GENERAL RULES (سندش در دسترسِ این خط نبود)، مغایرتِ TTNHِ
> پنجره‌ی ۰۹۳۰-۱۰۳۰ (حل‌نشده)، و SpreadLogِ کامل برایِ به‌روزرسانیِ نهاییِ اسپرد. جزئیاتِ کامل:
> [`docs/NY_FrozenDefinitions.md`](docs/NY_FrozenDefinitions.md).
