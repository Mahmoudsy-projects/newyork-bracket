...
> ## 🏷️ وضعیتِ فعلی: **قدمِ ۲ بسته ✅ — قدمِ ۳ی موقت در حالِ اجرا (تأییدِ مدیرِ پروژه، v1.6)**
...
>
> **مدیرِ پروژه تأیید کرد ادامه بدهیم** تا رسیدنِ دیتایِ کاملِ SpreadLog/NewsDay
> (`docs/Manager_Decision_20260823.md`): جاروی استاپ پارامتریک شد (`InpStopDepthPct`)، NewsDay حالا
> پیش‌فرض از تقویمِ داخلیِ MT5 پر می‌شود (نه فایلِ خارجی)، و یک مدلِ هزینه‌یِ موقتِ ثابت (۰.۰۶R/لگ)
> در `tools/analyze_ny.py` اعمال شد. **قدمِ بعدی:** ۷ اجرایِ تازه‌یِ MT5 با کدِ v1.6 رویِ Errante
> ۱۷ماهه (۲ پنجره × ۳ استاپ + ریورسِ ۸:۳۰) تا `NY_Standalone_Report_PRELIM.md` ساخته شود. جزئیاتِ
> کامل: [`docs/NY_FrozenDefinitions.md`](docs/NY_FrozenDefinitions.md).
