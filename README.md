...
> ## 🏷️ وضعیتِ فعلی: **حکمِ رسمی صادر شد ✅ — این فاز بسته، منتظرِ SpreadLogِ کامل**
> **حکمِ رسمیِ لاینِ اصلی (۲۵ اوت):** NY مستقل = رد. NY جانشین (معماریِ A، توکیو+NY فقط در
> روزهایِ بی‌تریدِ توکیو) = قبولِ مشروط. استاپِ نهایی = ۰.۵۰ (تأیید شد).
>
> گزارشِ کاملِ نهایی (کارهایِ ۱-۴ + مغایرتِ TTNHِ حل‌شده + حکمِ رسمی):
...
> **از این پس تا رسیدنِ SpreadLogِ کامل، طبقِ دستورِ صریحِ لاینِ اصلی: فقط انتظار — کارِ جدیدی
> رویِ NY تعریف/شروع نمی‌شود.** سندِ معیارهایِ رسمی (GENERAL RULES، چارچوبِ ۹ملاکه) هنوز نرسیده.
> جزئیاتِ کامل: [`docs/NY_FrozenDefinitions.md`](docs/NY_FrozenDefinitions.md).
