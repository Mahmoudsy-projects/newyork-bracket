...
> ## 🏷️ وضعیتِ فعلی: **فازِ ۱، قدمِ ۱ کامل — منتظرِ اجرا در MetaEditor**
> کدِ اسکریپتِ دیتا (سه ماژول + اسکریپتِ اصلی)، مستندِ تعریف‌های فریزشده، Ground Truth (از
> `NY_Box_Backtest_v2.xlsx`)، و ابزارهایِ قدمِ ۲/۳ (Python) نوشته شده‌اند. **کامپایل/اجرا نشده‌اند**
> — این ریپو محیطِ MT5 ندارد. قدمِ بعدی: اجرایِ اسکریپت در MetaEditor برایِ هر سه پنجره روی XAUUSD،
> سپس `tools/compare_ground_truth.py` برایِ صحت‌سنجی.
